...
const Footer = () => {
    return(
      ...
      <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 This Application is powered by {' '}<a href="https://thedogapi.com" class="hover:underline">The Dog API™</a>. All Rights Reserved.
    </span>
